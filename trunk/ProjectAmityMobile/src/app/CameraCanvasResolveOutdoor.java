...
public class CameraCanvasResolveOutdoor
    extends Canvas {

  private AmityMIDlet mAmityMIDlet;

  public CameraCanvasResolveOutdoor(AmityMIDlet midlet, VideoControl videoControl) {
    int width = getWidth();
...
//    g.drawRect(1, 1, width - 3, height - 3);
  ...
  public void keyPressed(int keyCode) {
    ...
    if (action == FIRE)
      mAmityMIDlet.captureResolveOutdoor();
  }
}
